...
"""
    Description:
        Setuptools entrypoint for aws-lambda-slickdeals
...
def main():
    ...
    setup(
        ...
        description=("Slickdeals Lambda Function in AWS"),
        include_package_data=True,
        install_requires=install_requirements,
        keywords=["python", "AWS", "lambda", "Slickdeals"],
        long_description=readme,
        long_description_content_type='text/markdown',
        name="aws-lambda-slickdeals",
        packages=packages,
        project_urls={},
        python_requires=">3.7",
        scripts=["bin/lambda_entrypoint.py"],
        setup_requires=setup_requirements,
        tests_require=test_requirements,
        url="https://github.com/ChristopherHaydenTodd/aws-lambda-slickdeals",
        version=version,
    )
